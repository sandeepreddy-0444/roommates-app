...
export default function GroceryPage() {
  ...
  <button onClick={() => router.push("/room")} className="border px-4 py-2 rounded">
    Room
  </button>

  <button onClick={() => router.push("/expenses")} className="border px-4 py-2 rounded">
    Expenses
  </button>
    ...
    Logout
        ...
        <form onSubmit={addItem} className="border rounded-2xl p-4 space-y-3">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            ...
            <input
              className="rounded-xl border p-3"
              placeholder="Qty (optional) e.g., 2kg, 1 dozen"
              value={qty}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className={it.bought ? "line-through text-gray-500" : ""}>
                      ...
                      {it.qty ? <span className="text-gray-600"> • {it.qty}</span> : null}
                    </div>
